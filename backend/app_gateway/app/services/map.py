...
SERVICE_MAP = {
    ...
    "auth": "http://127.0.0.1:8003",  # <-- Bas yeh LINE add karni hai
}
...
# hamesha ek baat ka dhayan rakhe jab bhi app koi api call kare to check kare ki kya oo service map me jo name hai usako sabase pahale rakha hai ya ahi